...
import './page.css';
import url1977 from 'url:../data/ennorath_data_1977.json';
import useData from '../data/use-data';

export default function Ennorath1977() {
    const info = useData(url1977);
    if (!info) {
        return <></>;
    }
    const {date_max, date_min, data, mapNames} = info;
    return(<div>
        <h1>Ennorath 1.9.7.7 stats</h1>
        <h2>{date_min}</h2>
        <h2>{date_max}</h2>
        <div>
            <p><a href={'/ennorath-stats/1973.html'}>к 1.9.7.3</a></p>
            <p><a href={'/ennorath-stats/1975.html'}>к 1.9.7.5</a></p>
            <p><a href={'/ennorath-stats/1976.html'}>к 1.9.7.6</a></p>
        </div>
        <div>
